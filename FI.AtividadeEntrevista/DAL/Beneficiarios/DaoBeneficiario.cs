...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        /// <summary>
        /// Consulta um Beneficiario pelo CPF
        /// </summary>
        /// <param name="cpf">cpf do beneficiário</param>
        /// <param name="idCliente">id do cliente</param>
        internal DML.Beneficiario ConsultarCPF(string cpf, long idCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            DataSet ds = base.Consultar("FI_SP_ConsBenefCPF", parametros);
        ...
        /// <summary>
        /// Lista todos os Beneficiarios Ou todos para um cliente específico
        /// </summary>
        internal List<DML.Beneficiario> Listar(long? id = null)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("IdCliente", id ?? 0));
